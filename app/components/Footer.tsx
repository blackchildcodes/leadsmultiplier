          ...
          <div className="grid md:grid-cols-3 py-4">
            ...
            <div className="py-8 px-4">
                ...
                <Image
                    ...
                    height={150}
                    alt=""
                    className="text-justify mb-3 flex items-center gap-3"
                />
                </Link>
              <p className="text-sm">
                Elevate your business with LeadsMultiplier – your ultimate partner in client acquisition excellence.
              </p>
              <br />
